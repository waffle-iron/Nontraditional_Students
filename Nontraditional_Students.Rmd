...
Let's look at a few students that do not fall into any of thesee categories:
```{r }
data_processed_alpha %>%
  filter(!is_undergrad & !is_grad & !is_prof_practice) %>%
  datatable()
```
